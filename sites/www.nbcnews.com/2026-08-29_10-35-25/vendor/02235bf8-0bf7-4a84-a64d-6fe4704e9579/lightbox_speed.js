...
(function (digioh_loader) {
    ...
    if (qaMode) {
        loadScript("user", "user_qa.js", "639232732871404572");
    loadScript("custom", "custom_qa.js", "0B8740479C09BD36FD5BCDAD19BB233D");
    loadScript("main", "main_qa.js", "E19FE7E997E1950FF0690022A331DD8F");
    }
    else {
        loadScript("user", "user.js", "639232732871404572");
    loadScript("custom", "custom.js", "52C26F7A521E55C3A3BAD61DED3A1F4F");
    loadScript("main", "main.js", "016C18FDE61B666039F460FBA9267B05");
    }
