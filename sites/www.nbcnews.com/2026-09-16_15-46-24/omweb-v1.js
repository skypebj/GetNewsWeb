/**
3rd party script
@see https://interactiveadvertisingbureau.github.io/Open-Measurement-SDKJS/#acquiring-the-om-sdk
 */
(function(omidGlobal) {
    'use strict';
    var n;
    ...
    x('Map', function(a) {
        ...
        function d(g, h) {
            ...
            if (m && y(g.b, k))
                for (g = 0; g < m.length; g++) {
                    var u = m[g];
                    if ((h !== h && u.key !== u.key) || h === u.key) return { id: k, list: m, index: g, o: u };
                }
        ...
        e.prototype.set = function(g, h) {
            ...
            k.o
                ? (k.o.value = h)
                : ((k.o = { next: this.a, D: this.a.D, head: this.a, key: g, value: h }),
                  k.list.push(k.o),
                  (this.a.D.next = k.o),
                  (this.a.D = k.o),
                  this.size++);
    ...
    function va(a) {
        var b = [],
            c = [],
            d = { viewport: a.i, adView: { percentageInView: a.l, pixelsInView: a.m, reasons: a.g }, declaredFriendlyObstructions: a.h.length };
        if (void 0 !== a.a) {
            ...
            for (e = 0; e < a.s.length; e++) {
                ...
                f = ta(a.a, f);
                c.push(Object.assign({}, { x: f.x, y: f.y, width: f.B - f.x, height: f.C - f.y }, g));
            }
    ...
    function Ba(a, b) {
        if (I(b) || !a.b) b = !1;
            ...
            var f = b.B;
            c = c.x;
            (f = f < c || 0.01 > Math.abs(f - c)) || ((f = b.x), (f = f > e || 0.01 > Math.abs(f - e)));
            ...
            'notAttached' === l.v || 'noWindowFocus' === l.v || 'noAdView' === l.v
                ...
                : ((l = c.a),
                  ...
                  I(c.a)
                      ...
                      : (c.a.g || (K(c, 'backgrounded'), K(c, 'noWindowFocus')), za(a, f) && K(c, 'clipped'), (c.b = new B(a, !1))));
        } else if (((f = !0), b.a && (f = -1 !== b.S.indexOf(d) ? !1 : !1 === b.L), f)) {
            l = b.J;
        ...
        e ||
            ...
            (b.a
                ? -1 !== b.S.indexOf(d)
                    ? c.h.push(b)
                    : c.j.push(b)
                : ((e = F(b)), (d = F(c.b)), E(c.b), !I(c.b) && b.L && ((b = ya(d, e)), za(b, d) && (K(c, 'clipped'), (c.b = new B(b, !1))))));
    }
    function Da(a, b) {
        this.y = this.x = 0;
        this.width = a;
    ...
    function Ea() {
        return {
            ...
            accessMode: 'limited',
            environment: 'web',
            omidJsInfo: { omidImplementer: 'omsdk', serviceVersion: '1.3.36-iab3524' },
            adSessionType: 'html',
            supports: ['clid', 'vlid'],
        };
    }
    ...
    function Ra(a, b, c) {
        'media' === b || 'video' === b ? Sa(a, c) : (a.c.push({ type: b, I: c }), Qa(a, b, c));
    }
    function Sa(a, b) {
    ...
    function Xa(a, b) {
        ...
        b = a.a.c;
        if (void 0 !== b) {
            b = Object.assign({}, Ya(a, Za(a, { context: b }), !0), { supportsLoadedEvent: !!a.a.b || 'video' == a.a.a });
    ...
    function Va(a, b, c) {
        ...
        c.U &&
            ...
            'full' === c.accessMode && (a.a.g && (b.data.context.videoElement = a.a.g), a.a.f && (b.data.context.slotElement = a.a.f)));
    }
    function ab(a) {
        var b = a.g,
    ...
    function $a(a) {
        var b = a.f
                .filter(function(f) {
                    return (Object.values(A).includes(f.event.type) && 'video' == a.a.a && f.origin === a.a.j) ||
                        ('loaded' == f.event.type && 'display' == a.a.a && f.origin === a.a.i)
                        ? !0
                        : !1;
                })
                .map(function(f) {
    ...
    function Ya(a, b, c) {
        ...
        a.a.b && (c || 'definedByJavaScript' !== a.a.b) && Object.assign(b, { creativeType: a.a.b });
        return b;
    }
    function Za(a, b) {
    ...
    function Ua(a) {
        a = a.event;
        return { adSessionId: a.adSessionId, timestamp: a.timestamp, type: a.type, data: a.data };
    }
    function eb(a) {
        ...
        if (this.g) {
            ...
            if (e)
                ...
                (a.g = ['unmeasurable']),
                    ...
                    (a.l = 0),
                    (a.f = []),
                    a.a && ((b = a.a), (c = {}), (b = new B(((c.x = 0), (c.y = 0), (c.width = b.width), (c.height = b.height), c), b.a)), (a.a = b)),
                    (a.b = xa());
            this.F = a;
        }
    };
    ...
    U.prototype.K = function() {
        if (this.a && this.G) {
            ...
            if (a) {
                ...
                f <= d || a <= e
                    ? (d = null)
                    : ((c = {}), (d = new B(((c.x = d), (c.y = e), (c.width = Math.abs(f - d)), (c.height = Math.abs(a - e)), c), !1)));
            ...
            e.b = d;
            Aa(e);
            this.P ? (!f && I(e.a) ? K(e, 'hidden') : f || 100 === e.l || K(e, 'clipped')) : K(e, 'viewport');
            this.F = e;
        }
    };
    ...
    function Ib(a) {
        ...
        null == b.omidSessionInterface &&
            ((a = {
                ...
                adEvents: { impressionOccurred: X(a, 'impressionOccurred'), loaded: X(a, 'loaded') },
                mediaEvents: {
                    start: X(a, 'start'),
            ...
            Object.freeze(a),
            Object.defineProperty(b, 'omidSessionInterface', { value: a, writable: !1 }));
    }
    function Jb(a, b) {
    ...
    function Z(a, b, c) {
        if ('impression' == b)
            cb(a.c) &&
                ((b = a.c), (c = (c = M().w) ? va(c) : void 0), (c = Ya(b, Za(b, c))), Pa(b, P(b, 'impression', 'javascript', c)), a.b && fb(a.b));
        else {
            if ('loaded' == b) {
                var d = c;
                d = void 0 === d ? null : d;
                db(a.c) &&
                    ...
                    ((d = P(c, 'loaded', 'javascript', Ya(c, Za(c, void 0 === d ? null : d)))), Pa(c, d));
            } else if (db(a.c)) {
                d = a.c;
                ...
                if (c && ('start' === b || 'volumeChange' === b)) {
                    ...
                    null != e
                        ...
                        : null != f && (Object.assign(c, { videoPlayerVolume: f }), (d.a.H = f));
                }
        ...
        if (!this.a.a || this.a.b)
            (this.a.b = a),
                'video' == a || 'audio' == a
                    ...
                    ? (this.a.a = 'display')
                    : 'definedByJavaScript' == a && b && (this.a.a = 'none' == b ? 'display' : 'video');
    };
    ...
    n.setClientInfo = function(a, b, c) {
        var d = this.a.c || {};
        d.omidJsInfo = Object.assign({}, d.omidJsInfo, { sessionClientVersion: a, partnerName: b, partnerVersion: c });
        this.a.c = d;
            ...
            switch (Fb(b)) {
                ...
                case 'setVideoElement':
                    ...
                    e && e.tagName && 'video' === e.tagName.toLowerCase()
                        ? ((a.a.g = e), a.b && gb(a.b))
                        : O('setVideoElement called with a non-HTMLVideoElement. It will be ignored.');
                    break;
                ...
                case 'loaded':
                    (e = p(d).next().value)
                        ? ((c = { skippable: e.isSkippable, autoPlay: e.isAutoPlay, position: e.position }),
