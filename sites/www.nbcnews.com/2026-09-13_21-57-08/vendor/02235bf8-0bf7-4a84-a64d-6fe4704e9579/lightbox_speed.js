...
(function (digioh_loader) {
    ...
    if (qaMode) {
        loadScript("user", "user_qa.js", "639247543708890828");
    loadScript("custom", "custom_qa.js", "0B8740479C09BD36FD5BCDAD19BB233D");
    loadScript("main", "main_qa.js", "14596149AB18731CFDA1D6E54F7058C0");
    }
    else {
        loadScript("user", "user.js", "639247543708890828");
    loadScript("custom", "custom.js", "52C26F7A521E55C3A3BAD61DED3A1F4F");
    loadScript("main", "main.js", "54BE5223F9E8C681A9AB2367B9E8E9E6");
    }
