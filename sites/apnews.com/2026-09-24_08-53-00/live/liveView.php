		...
		if (type == 'gdpr') {
			...
			if (typeof this.gppResolve === 'function') {
				...
				var urlDetObj = new SekindoClientDetections_URL({
					url: 'https://live.primis.tech/live/liveView.php?s=122329&cbuster=1790239997',
