...
if (!_tb_dis) {
    ...
    var _pmpmk = pm_ppy + '/pmk-20220605.16.js';
    var _pmasync = true;
...
var _tb_vpx = [{
     'xpath': '//div[contains(@class,"js-video")]//iframe',
     'attr': 'iframe'
 },
{
     'xpath': '//div[contains(@class,"uw-iframe-video ")]//iframe',
     'attr': 'iframe'
 },
{
     'xpath':'//div[contains(@class,"teal-video-wrap")]',
     'attr': 'div'
}
