    ...
    if (window.DotMetricsInitScript == undefined) {
        ...
        function start(hasConsent){
            ...
            if(!hitDone){
                ...
                var imgUrl = 'https://uk-script.dotmetrics.net/hit.gif?id=13934&url=' + pageUrl + '&dom=' + domain + '&r=' + rand + '&pvs=' + pvs + '&ecid=' + ecid + dcOpt + '&c=' + hasConsent + '&tzOffset=' + tzOffset + '&doorUrl=' + doorUrl + '&dfph=' + domainFph+'&ver=366';
                        ...
                        window.DotMetricsSettings =
                            {
                                ...
                                ScriptUrl:  'https://uk-script.dotmetrics.net/Scripts/script.js?v=366',
                                ScriptDebugUrl:  'https://download.dotmetrics.net/Script/script.debug.js?v=db3b1d75-b5cd-46ac-ada9-b06fa3813af8',
                                NCSScriptUrl: 'https://uk-script.dotmetrics.net/Scripts/ncs-script.js?v=366',
                                NCSScriptDebugUrl: 'https://download.dotmetrics.net/Script/ncs-script.debug.js?v=5ad4fb72-16c6-47fe-ad97-a50fb2c1beb9',
                                AdexConfigUrl: 'https://script.api/DotMetrics.Script.Adex/adexConfig.js?v=366&id=13934',
                                SiteSectionId: 13934,
                                SiteId: 1778,
