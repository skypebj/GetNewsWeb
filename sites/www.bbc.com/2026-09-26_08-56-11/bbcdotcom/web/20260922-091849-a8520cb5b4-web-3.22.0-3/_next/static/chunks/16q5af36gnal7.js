...
`,u=a.default.div.withConfig({displayName:"Popover.styles__PopoverOverlayBgStyled",componentId:"sc-a280de2f-0"})`
  ...
  ${(0,c.applyStylesForBreakpoints)(a.css`
    ...
    `,"group1","group2")};
`,p=a.default.div.withConfig({displayName:"Popover.styles__PopoverWrapperStyled",componentId:"sc-a280de2f-1"})`
  position: relative;
  display: flex;
  align-items: center;
`,d=a.default.div.withConfig({displayName:"Popover.styles__PopoverStyled",componentId:"sc-a280de2f-2"})`
  ${({theme:t,$isOpen:e,$animate:o,$alignment:n,$widthDiff:i,$withTransition:r,$isInverse:s,$isOnLeftEdge:u})=>a.css`
    position: absolute;
    min-width: 140px;
...
`,h=a.default.button.withConfig({displayName:"Popover.styles__CloseButton",componentId:"sc-a280de2f-3"})`
  ...
  ${(0,c.applyStylesForBreakpoints)(a.css`
      ...
      `};
    `,"group1","group2")};
`,f=(0,o.memo)((0,o.forwardRef)(({content:t,trigger:o,isOpen:n,isInverse:i,isOnLeftEdge:r,withOverlayBackground:a,withTransition:c,animate:l,transition:p,alignment:f,widthDiff:b,togglePopover:v},m)=>(0,e.jsxs)(e.Fragment,{children:[a&&(0,e.jsx)(u,{"data-testid":"popoverOverlay"}),(0,e.jsx)(d,{ref:m,$isOnLeftEdge:r,$isInverse:i,"data-testid":"popoverStyled",className:"popover",$isOpen:n,$withTransition:c,$animate:l,$transition:p,$alignment:f,$widthDiff:b??0,tabIndex:-1,children:(0,e.jsxs)(e.Fragment,{children:[t,"hover"!==o&&(0,e.jsx)(h,{"data-testid":"popoverCloseButton",onClick:()=>v(!1),children:(0,e.jsx)(s.default,{name:"actions:close",width:20,height:20})})]})})]})));t.s(["default",0,({content:t,trigger:s="click",alignment:a="bottom",withTransition:c,transition:l,children:u,isInverse:d=!1,isOnLeftEdge:h,withOverlayBackground:b=!1,onOpenChange:v})=>{let[m,g]=(0,o.useState)(!1),[y,w]=(0,o.useState)(null),[x,_]=(0,o.useState)(null),[k,S]=(0,o.useState)(!1),[$]=(0,i.useBreakpoints)("popover"),C=["group1","group2"].includes($),E=(0,o.useRef)(null),O=(0,o.useRef)(null),B=(0,o.useRef)(null),I=(0,o.useCallback)(t=>{if(O.current=t,t){let{height:e,width:o}=t.getBoundingClientRect();_({height:e,width:o}),"click"===s&&requestAnimationFrame(()=>{t&&(t.focus(),"function"==typeof t.scrollIntoView&&t.scrollIntoView({behavior:"smooth",block:"nearest"}))})}},[s]),R=(0,o.useCallback)(t=>{if(B.current=t,t){let{height:e,width:o}=t.getBoundingClientRect();w({height:e,width:o})}},[]);(0,r.useResizeObserver)(O,t=>{let[{contentRect:e}]=t,{height:o,width:n}=e;(x?.height!==o||x?.width!==n)&&_({height:o,width:n})},100),(0,r.useResizeObserver)(B,t=>{let[{contentRect:e}]=t,{height:o,width:n}=e;(y?.height!==o||y?.width!==n)&&w({height:o,width:n})},100);let T=(0,o.useCallback)(t=>{let e=t?g:S,o=t?S:g,n=t?10:200;e(t),setTimeout(()=>{o(t)},n),v?.(t)},[v]),j=(0,o.useCallback)(()=>"hover"===s&&T(!m),[m,T,s]),A=(0,o.useCallback)(()=>"focus"===s&&T(!m),[m,T,s]),P=(0,o.useCallback)(()=>"click"===s?null:"hover"===s&&T(!1),[T,s]),M=(0,o.useCallback)(()=>"click"!==s&&T(!1),[T,s]),F=(0,o.useCallback)(t=>{E.current&&!E.current?.contains(t.target)&&T(!1)},[T]);(0,o.useEffect)(()=>(document.addEventListener("click",t=>F(t)),document.addEventListener("keydown",t=>{let{key:e,keyCode:o}=t;("Escape"===e||"Esc"===e||27===o)&&(T(!1),document.activeElement.blur())}),()=>document.removeEventListener("click",F)),[M,T,m,F]);let L=x&&y&&Math.abs(x?.width-y?.width)/2;return u?(0,e.jsxs)(p,{"data-testid":"popoverWrapper",ref:E,id:"popover-wrapper",onClick:t=>{let e=t.target;"click"===s&&e?.closest("#popover-trigger")&&T(!m)},onMouseEnter:j,onMouseLeave:P,onBlur:M,onFocus:A,children:[(0,e.jsx)("div",{"data-testid":"popoverTrigger",id:"popover-trigger",ref:R,children:u}),m&&(C?(0,n.createPortal)((0,e.jsx)(f,{ref:I,content:t,trigger:s,isOpen:m,isInverse:d,isOnLeftEdge:h,withOverlayBackground:b,withTransition:c,animate:k,transition:l,alignment:a,widthDiff:L,togglePopover:T}),document.body):(0,e.jsx)(f,{ref:I,content:t,trigger:s,isOpen:m,isInverse:d,isOnLeftEdge:h,withOverlayBackground:b,withTransition:c,animate:k,transition:l,alignment:a,widthDiff:L,togglePopover:T}))]}):null}],167971)},490602,t=>{"use strict";var e=t.i(391398),o=t.i(84541),n=t.i(868783),i=t.i(746857),r=t.i(704570),s=t.i(167971),a=t.i(191788);let c={facebook:{text:"Facebook",icon:"social:facebook",onClick:t=>{let e=`https://www.facebook.com/sharer/sharer.php?u=${encodeURIComponent(t)}`;window.open(e,"_blank")}},twitter:{text:"X (Twitter)",icon:"social:x",onClick:t=>{let e=`https://twitter.com/intent/tweet?url=${encodeURIComponent(t)}`;window.open(e,"_blank")}},linkedin:{text:"LinkedIn",icon:"social:linkedin",onClick:t=>{let e=encodeURIComponent(t),o=`https://www.linkedin.com/shareArticle?mini=true&url=${e}`;window.open(o,"_blank")}},email:{text:"Email",icon:"social:email",onClick:(t,e)=>{let o=`Shared from BBC: ${e||t}`,n=`Check this out from the BBC: ${t}`,i=`mailto:?subject=${encodeURIComponent(o)}&body=${encodeURIComponent(n)}`;window.location.href=i}},copy:{text:"Copy",icon:"social:copy",onClick:async t=>{await navigator.clipboard.writeText(t)}}},l=({type:t,withoutPadding:n=!1,link:i,isInverse:r=!0,title:s,isAv:l,contentId:u,avProperties:p,contentTopic:d})=>{let h=c[t],[f,b]=(0,a.useState)(!1),{onClick:v,text:m,icon:g}=h;return(0,e.jsx)(o.default,{withoutPaddingInline:n,testId:`${t}ShareButton`,type:"social-unboxed-share",isInverse:r,icon:f?"actions:checkmark":g,onClick:()=>{"copy"===t&&b(!0),window.analytics.sendEvent({eventGrouping:l?"av_share":"article_share",eventProperties:{item_name:t,item_link:i,contentId:u,...p||{},...d?{content_topic:d}:{}}}),v(i,s)},text:f?"Link copied":m,disabled:f,isInPopover:!0})},u=(t,o,n,i,r,s,a)=>Object.keys(c).map((c,u)=>(0,e.jsx)(l,{isAv:i,type:c,...r&&{contentId:r},contentTopic:s,link:`https://bbc.com${t}`,isInverse:o,group_name:"share_menu",title:n,avProperties:a},u)),p=(0,n.withCMSFallback)(({trigger:t,isInverse:n=!1,isButtonInverse:a=!1,iconPosition:c="left",withoutPaddingInline:l=!1,href:p,title:d,isOnLeftEdge:h,type:f="unboxed-share",size:b="small",alignment:v,withOverlayBackground:m=!1,avProperties:g,iconOnly:y=!1,isAvContent:w,onOpenChange:x})=>{let{asPath:_}=(0,i.useAppRouter)(),{type:k,id:S=""}=(0,r.usePageData)(),$=u(p||_,n,d,w??("audio"===k||"video"===k||"/video"===_),S,"",g);return(0,e.jsx)(s.default,{withOverlayBackground:m,alignment:v,isInverse:n,trigger:t,content:$,isOnLeftEdge:h,onOpenChange:x,children:(0,e.jsx)(o.default,{isInverse:a,withoutPaddingInline:l,size:b,iconPosition:c,testId:"socialShareTriggerButton",type:f,icon:"social:share",ariaLabel:y?"Share":void 0,...!y&&{text:"Share"}})})},({isInverse:t=!1,iconPosition:n="left",withoutPaddingInline:i=!1,trigger:r,isOnLeftEdge:a,href:u=window.location.pathname})=>(0,e.jsx)(s.default,{isInverse:t,trigger:r,content:Object.keys(c).map((o,n)=>(0,e.jsx)(l,{type:o,link:u,isInverse:t,isAv:!1,contentTopic:""},n)),isOnLeftEdge:a,children:(0,e.jsx)(o.default,{isInverse:t,withoutPaddingInline:i,size:"small",iconPosition:n,testId:"socialShareTriggerButton",type:"unboxed-share",icon:"social:share",text:"Share"})}));t.s(["default",0,p,"getSocialPopoverContent",0,u],490602)},542383,825893,t=>{"use strict";var e=t.i(191788),o=t.i(391398),n=t.i(480495),i=t.i(317166),r=t.i(830945);let s=(0,e.createContext)({dotcom:{isConsentReady:!1,hasFullSourcepointConsent:!1,hasTaboolaConsent:!1},account:{hasPersonalizedContentConsent:!1}}),{Provider:a}=s;t.s(["UserConsentContext",0,s,"UserConsentProvider",0,({children:t})=>{let[s,c]=(0,e.useState)(!1),[l,u]=(0,e.useState)(!1),[p,d]=(0,e.useState)(!1),[h,f]=(0,e.useState)(!1),{isSignedIn:b}=(0,i.useUser)();return(0,e.useEffect)(()=>{let t=()=>{window.removeEventListener("ngas:consentReady",t),c(!0),u(window?.dotcom?.consent?.sp===2),f(window.dotcom.consent.gppApplies?2===window.dotcom.consent.sp:!!window.dotcom.consent.gdprApplies&&!!window.dotcom.consent.vendor.taboola)};return window?.dotcom?.consent?.consentReady?t():window.addEventListener("ngas:consentReady",t),()=>window.removeEventListener("ngas:consentReady",t)},[]),(0,e.useEffect)(()=>{try{if(b&&l){let t=String((0,n.getCookie)(r.USER_ID)),{ep:e}=JSON.parse(atob(t));d(!!e)}else d(l)}catch{d(l)}},[l,b]),(0,o.jsx)(a,{value:{dotcom:{isConsentReady:s,hasFullSourcepointConsent:l,hasTaboolaConsent:h},account:{hasPersonalizedContentConsent:p}},children:t})}],825893),t.s(["useConsent",0,function(){return(0,e.useContext)(s)}],542383)},524431,t=>{"use strict";var e=t.i(191788),o=t.i(520087),n=t.i(542383),i=t.i(519894),r=t.i(704570),s=t.i(227162),a=t.i(395497);let c={"Facebook.ActionSource":"website","Facebook.EventSourceUrl":"https://www.bbc.com"};t.s(["useLogMparticleEvent",0,function(){let t=(0,i.useFeatureFlag)("mparticle-sdk"),l=s.appConfig.getValue(a.ConfigSettings.MparticleKey),{country:u}=(0,r.usePageData)(),{dotcom:{hasFullSourcepointConsent:p}}=(0,n.useConsent)();return(0,e.useCallback)((e,n,i)=>{t&&l&&"us"===u&&p&&(o.default.logEvent(e,o.default.EventType.Other,{source:"piano",eventName:e,page:window.location.toString(),referrer:document.referrer,userAgent:navigator.userAgent,...n},c),i?.forceUpload&&o.default.upload())},[t,l,u,p])}],524431)},686764,t=>{"use strict";t.s(["default",0,({condition:t,wrapper:e,children:o})=>t?e(o):o])},162644,t=>{"use strict";var e=t.i(391398),o=t.i(746857),n=t.i(704570),i=t.i(167971),r=t.i(490602),s=t.i(760814),a=t.i(339228),c=t.i(84541),l=t.i(567290);let u=(0,s.default)(c.default).withConfig({displayName:"SocialSharePopover.styles__VideoSocialShareButtonStyled",componentId:"sc-4998b4eb-0"})`
  min-width: unset;
  ...
  ${(0,a.applyStylesForBreakpoints)(s.css`
    ...
    `,"group2")};
`;t.s(["default",0,({title:t,avProperties:s,contentTopic:a})=>{let{asPath:c}=(0,o.useAppRouter)(),{id:l=""}=(0,n.usePageData)(),p=(0,r.getSocialPopoverContent)(c,!0,t,!0,l,a,s);return(0,e.jsx)(i.default,{content:p,alignment:"bottom-left",children:(0,e.jsx)(u,{isInverse:!0,size:"large",iconPosition:"left",testId:"socialShareTriggerButton",type:"round",icon:"social:share",text:"Share"})})}],162644)},818883,t=>{"use strict";var e=t.i(760814),o=t.i(339228),n=t.i(570549),i=t.i(84541);let r=e.default.div.withConfig({displayName:"SeriesCtas.styles__SeriesCtasStyled",componentId:"sc-bca9824d-0"})`
  display: flex;
  column-gap: 16px;
