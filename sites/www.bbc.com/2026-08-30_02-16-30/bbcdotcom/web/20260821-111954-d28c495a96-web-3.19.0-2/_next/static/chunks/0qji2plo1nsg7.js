(globalThis.TURBOPACK||(globalThis.TURBOPACK=[])).push(["object"==typeof document?document.currentScript:void 0,789799,24768,e=>{"use strict";var t=e.i(391398),i=e.i(191788),a=e.i(480495),n=e.i(519894),s=e.i(508259);let l="ckns_subscription_status",o={longFormVideo:"longFormVideo",AdFreeAudio:"AdFreeAudio"};e.s(["CHECKOUT_STATE_COOKIE",0,"ckns_checkout_state","CUSTOM_FORM",0,"MarketingConsent","CUSTOM_FORM_FIELD_NAME",0,"MarketingConsent","SUBSCRIPTION_CLAIM",0,o,"SUBSCRIPTION_REDIRECT_PATH_LOCAL_STORAGE_KEY",0,"subliminal_redirect_path","SUBSCRIPTION_SETTINGS_COOKIE",0,"ckns_subscription_settings","SUBSCRIPTION_SETTINGS_MANAGEMENT",0,"/settings/subscription-management","SUBSCRIPTION_STATUS_COOKIE",0,l],24768);var r=e.i(184919),d=e.i(704570),u=e.i(317166),c=e.i(227162),p=e.i(395497),g=e.i(830945);let y=["invalid-user error","invalid-signature error"],m=Object.keys(o),b=e=>{let t={};return Object.keys(o).forEach(i=>{t[i]=e}),t},h=()=>{let e={};return Object.keys(o).forEach(t=>{e[t]="PENDING"}),e},f=e=>Object.values(e).some(e=>"ALLOWED"===e),C={isSubscribed:!1,isSubscriptionAllowed:!1,claims:h(),subscriptionClaimsFetch:"IDLE",isSubscriptionCheckComplete:!1},v=(0,i.createContext)(C),S=(0,i.createContext)(()=>null),w=(0,i.createContext)(()=>null);e.s(["SubscriptionProvider",0,({value:{isSubscriptionAllowed:e},children:o})=>{let I=(0,n.useFeatureFlag)("subscription-claims-based"),[x,P]=(0,i.useState)(0),{claims:E,subscriptionClaimsFetch:_}=((e=0,t)=>{let{ensureTokens:l}=(0,u.useUser)(),o=b("PENDING"),[h,f]=(0,i.useState)(o),[C,v]=(0,i.useState)("IDLE"),[S,w]=(0,i.useState)(void 0),[I,x]=(0,i.useState)(void 0),P=(0,n.useFeatureFlag)("subscription-claims-based"),{type:E,subtype:_}=(0,d.usePageData)(),O=E===r.ContentType.LongFormVideo&&(_===r.ContentSubtype.Series||_===r.ContentSubtype.Episode),F=E===r.ContentType.Audio,T=()=>{v("UNNECESSARY"),f(b("DENIED"))};return(0,i.useEffect)(()=>{let e=async()=>{await l();try{let e=c.appConfig.getValue(p.ConfigSettings.AuthProxyUrl),t=new URLSearchParams({__tac:S,ckns_registration:I});s.logger.info("LFV Auth: Making xproxy request to piano/token-auth",{hasTacCookie:!!S,hasRegCookie:!!I});let i=await fetch(`${e}/piano/token-auth`,{method:"POST",body:t});s.logger.info("LFV Auth: Received xproxy response",{status:i.status,statusText:i.statusText,ok:i.ok});let a=await i.text(),n=y.indexOf(a);if(-1!==n)throw Error(`xproxy token-auth call failed >>  ${y[n]}`);let l=JSON.parse(a),o=JSON.parse(l.sub),r=b("DENIED");if(s.logger.info("LFV Auth: Parsed subscription claims",{hasAccessList:!!o.al,hasUserId:!!o.u}),!o.al){s.logger.info("LFV Auth: No access list found - user not subscribed"),f(r),v("RESOLVED");return}let d=c.appConfig.getValue(p.ConfigSettings.PianoAid),u=o.al[d];s.logger.info("LFV Auth: Processing claims for Piano AID",{hasPianoAid:!!d}),u.forEach(e=>{m.includes(e.r)&&(r={...r,[e.r]:"ALLOWED"})}),s.logger.info("LFV Auth: Claims processing completed",{validClaims:r}),f(r),v("RESOLVED")}catch(e){s.logger.error(`LFV Auth: Xproxy fetch failed: ${e}`),f(b("ERROR")),v("ERROR")}};S&&I&&e()},[S,I]),(0,i.useEffect)(()=>{let e=!1,i=(0,a.getCookie)(g.PIANO_TAC),n=(0,a.getCookie)(g.PIANO_REG),l=!!(0,a.getCookie)(g.USER_ID);if(t)if(l)if(P||O||F)if(P?s.logger.info("[SUBSCRIPTION] Fetching claims (flag ON). Claims will determine subscription status."):s.logger.info("[SUBSCRIPTION] Fetching claims (flag OFF, LFV/Audio page). Claims for content gating only, cookies for subscription status."),i&&n)w(i),x(n),v("PENDING");else{let t=setTimeout(()=>e=!0,5e3),i=setInterval(()=>{let n=(0,a.getCookie)(g.PIANO_TAC),l=(0,a.getCookie)(g.PIANO_REG);n&&l?(w(n),x(l),v("PENDING"),clearInterval(i),clearTimeout(t)):e&&(f(b("ERROR")),v("TIMEOUT"),s.logger.error("LFV Auth: timed out waiting for piano values"),clearInterval(i))},200)}else s.logger.info("[SUBSCRIPTION] Skipping claims fetch (flag OFF, non-LFV/Audio page). Using cookies only."),v("UNNECESSARY");else T();else T()},[t,O,F,P,e]),{claims:h,subscriptionClaimsFetch:C}})(x,e);(0,i.useEffect)(()=>{T({claims:{...h(),...E},subscriptionClaimsFetch:_})},[E,_]);let[O,F]=(0,i.useState)({...C,isSubscribed:!I&&"active"===(0,a.getCookie)(l),isSubscriptionAllowed:e}),T=({isSubscribed:e,claims:t,subscriptionClaimsFetch:i})=>F(n=>{if(I){s.logger.info("[SUBSCRIPTION] Using claims-based logic (feature flag ON)");let e=t||n.claims,a=i||n.subscriptionClaimsFetch,l="RESOLVED"===a&&f(e);return s.logger.info("[SUBSCRIPTION] Claims result:",JSON.stringify({isSubscribed:l,fetchStatus:a,hasAnyClaim:f(e)})),{...n,isSubscribed:l,isSubscriptionCheckComplete:"RESOLVED"===a||"ERROR"===a||"TIMEOUT"===a||"UNNECESSARY"===a,...t&&{claims:t},...i&&{subscriptionClaimsFetch:i}}}{s.logger.info("[SUBSCRIPTION] Using cookie-based logic (feature flag OFF)");let o=i||n.subscriptionClaimsFetch;"RESOLVED"===o&&s.logger.info("[SUBSCRIPTION] Note: Claims were fetched for content gating but NOT used for subscription status"),e&&(0,a.setCookie)(l,"active",{domain:"bbc.com",maxAge:7800});let r=void 0!==e?e:n.isSubscribed;return s.logger.info("[SUBSCRIPTION] Cookie result:",JSON.stringify({isSubscribed:r,fetchStatus:o})),{...n,isSubscribed:r,isSubscriptionCheckComplete:"RESOLVED"===o||"ERROR"===o||"TIMEOUT"===o||"UNNECESSARY"===o,...t&&{claims:t},...i&&{subscriptionClaimsFetch:i}}}});return(0,t.jsx)(v.Provider,{value:O,children:(0,t.jsx)(S.Provider,{value:T,children:(0,t.jsx)(w.Provider,{value:()=>{P(e=>e+1)},children:o})})})},"useRefetchSubscriptionClaims",0,()=>(0,i.useContext)(w),"useSubscriptionContext",0,()=>(0,i.useContext)(v),"useSubscriptionUpdateContext",0,()=>(0,i.useContext)(S)],789799)},753924,399274,e=>{"use strict";var t=e.i(391398);let i=()=>(0,t.jsxs)("svg",{viewBox:"0 0 82 82",children:[(0,t.jsx)("circle",{cx:"41",cy:"41",r:"37",fill:"#fff"}),(0,t.jsx)("polygon",{fill:"#202224",points:"32,25 32,58 60,42"})]}),a=()=>(0,t.jsxs)("svg",{width:"15",height:"16",viewBox:"0 0 15 16",fill:"none",children:[(0,t.jsxs)("g",{clipPath:"url(#clip0_32424_6036)",children:[(0,t.jsx)("path",{d:"M7.5 15.2964C11.4844 15.2964 14.5312 12.2495 14.5312 8.26514C14.5312 4.28076 11.4844 1.23389 7.5 1.23389C3.51562 1.23389 0.46875 4.28076 0.46875 8.26514C0.46875 12.2495 3.51562 15.2964 7.5 15.2964Z",fill:"white"}),(0,t.jsx)("path",{d:"M7.5 15.2964C11.4844 15.2964 14.5312 12.2495 14.5312 8.26514C14.5312 4.28076 11.4844 1.23389 7.5 1.23389C3.51562 1.23389 0.46875 4.28076 0.46875 8.26514C0.46875 12.2495 3.51562 15.2964 7.5 15.2964ZM7.73438 12.2495C5.25 12.2495 3.70312 10.7495 3.70312 8.26514C3.70312 5.87451 5.34375 4.28076 7.92188 4.28076C8.85938 4.28076 9.70312 4.42139 10.4531 4.74951V6.39014C9.79688 6.10889 9.09375 5.87451 8.20312 5.87451C6.5625 5.87451 5.67188 6.71826 5.67188 8.31201C5.67188 10.2808 6.89062 11.0776 9.04688 10.6558V9.01514H7.6875V7.74951H10.6875V11.7339C9.84375 12.062 8.76562 12.2495 7.73438 12.2495Z",fill:"#FF0000"})]}),(0,t.jsx)("defs",{children:(0,t.jsx)("clipPath",{id:"clip0_32424_6036",children:(0,t.jsx)("rect",{width:"15",height:"15",fill:"white",transform:"translate(0 0.765137)"})})})]});var n=e.i(760814),s=e.i(339228),l=e.i(570549),o=e.i(222009);let r=n.default.div.withConfig({displayName:"CustomCTA.styles__CtaPlayIconStyled",componentId:"sc-be08601b-0"})`
...
`,g=n.default.div.withConfig({displayName:"Player.styles__ContentUnavailableSubTitleStyled",componentId:"sc-6416b0a0-7"})`
  ${({theme:e})=>n.css`
    ...
    text-align: center;
  `}
`;e.s(["ContentUnavailableSubTitleStyled",0,g,"ContentUnavailableTitleStyled",0,p,"ContentUnavailableWrapperStyled",0,c,"LongFormPlayerStyled",0,r,"PlayerStyled",0,d,"VideoPlayerStyled",0,u],978113)},427885,e=>{"use strict";var t=e.i(480495),i=e.i(494373),a=e.i(876278),n=e.i(830945),s=e.i(508259),l=e.i(318438),o=e.i(898229);let r=(e,t)=>"landscape"!==t&&t?{holdingImage:{url:e,orientation:t}}:{holdingImageURL:e},d=e=>{let t=Math.floor(e/60),i=e-60*t;return`${t}${0!==i?`:${i<10?`0${i}`:`${i}`}`:":00"}`};function u(e){let t=e??a.INDEX_CARD_IMAGE_FALLBACK;return t.includes("1920xn")?t.replace("1920xn","$recipe"):t}let c=(e,t,i=!1,a=!1,n="landscape",s="landscape")=>{let{page:o="",destination:r=l.siteLabel.test,producer:d="BBC_STUDIOS",content_id:u,content_topic:c,device_first_party_id:p,device_first_party_id_version:g,referrer_url:y,user_first_party_id:m,user_first_party_id_version:b,user_first_party_idp:h,user_id:f,content_window_is_enabled:C,early_access_start_date:v,early_access_end_date:S}=e||{};return{counterName:o,destination:r,producer:d,sessionLabels:{counterName:o,destination:r,producer:d,device_first_party_id:p,device_first_party_id_version:g,referrer_url:y,user_first_party_id:m,user_first_party_id_version:b,user_first_party_idp:h,user_id:f},playlistLabels:{content_id:t?.content_id||u,content_topic:t?.content_topic||c,av_show:t?.av_show,av_content_genre:t?.av_content_genre,content_type:t?.content_type,content_window_is_enabled:C,early_access_start_date:v,early_access_end_date:S,av_content_duration_range:i?"audio":"portrait"===n||"portrait"===s?"sfv-vertical":"sfv",ad_enabled:a}}},p=(e,i,a,s,l,o,r=!0,d=!1,u=0,c=!1,p=!1,g=!1)=>{let y={livePulseColour:"#FFFFFF",...d?{skin:"audio",skipInterval:20,colour:"#FFFFFF",controls:{includeNextButton:!0,includePreviousButton:!0,includeForwardIntervalButton:!0,includeBackIntervalButton:!0,alwaysEnablePreviousButton:!0,alwaysEnableNextButton:c,popout:!1,displayJumpButtonText:!0,previousNextJustEvents:!0,speed:!1},playbackSettingsPanel:{enabled:!g,continuousPlaySetting:!0}}:{poster:{verticalBlur:!0},cta:{enabled:!1,visiblyHidden:!0},controls:{availableOnMediaEnded:!0}},...d&&!p&&{colourOnHighlightColour:"#000000",cta:{enabled:!1,visiblyHidden:!0}},...d&&p&&{foreColour:"#000000"}},m={html5Debug:!1,product:"bbcx",playlistObject:e,autoplay:o,continuousPlay:r,waitOnPluginLoad:!0,enableToucan:!d||d&&p,supportFakeFullscreen:!0,counterName:l,appName:"bbc_web",appType:"responsive",allowCasting:!0,startTime:u,statsObject:i,ui:y,plugins:{toLoad:[]},...d&&{significantTime:1}},b=(0,t.getCookie)(n.ANALYTICS_APP)?.toString();b&&(m.appName=b,m.appType="mobile-web");let h={debug:!1,...d&&{audioAdTag:s},...!d&&{adTag:s}};a&&s&&m.plugins?.toLoad.push({html:"name:dfpAds.js",data:{name:"AdsPluginParameters",data:h}});let f=e.items[e.items.length-1];return f.serviceID&&!0===f.live&&!d&&m.plugins?.toLoad.push({html:"name:smp-subs-config-plugin.js",module:!0}),m},g=async(e,t)=>{try{let i=`media-token?${t?"serviceId":"versionPid"}=${e}`,{data:a}=await (0,o.fetchClient)(i,{});return a.token}catch(t){return s.logger.error(`getJwtToken failed for: ${e} - Error: ${t}`),""}},y=async(e,t,i="landscape",a,n=!1,s=!1)=>{let[l]=e.versions,{versionId:o="",duration:d=0,warning:c="",warnings:p={}}=l??{},y=n?await g(o,s):null,m={live:s,kind:n?"audio":"programme",duration:(e=>{let t=e.split(":");if(t.length>1){let e=parseInt(t[2].split(".")[0]);return 60*parseInt(t[0])*60+60*parseInt(t[1])+e}return parseInt(e)})(d.toString())};s?m.serviceID=o:m.versionID=o,y&&(m.jwtToken=y);let b=[m];return a&&b.unshift({kind:"advert"}),{title:e.title,summary:e.synopses.medium,items:b,...r(u(e.imageUrl),i),warning:c||p?.short,liveRewind:s,simulcast:s}},m=(e,t,i,a,n)=>({clipPID:e.id,destination:t,producer:i,playlistName:"",playerPosition:"",playlistLabels:n,sessionLabels:a}),b=e=>e?e.model.blocks.find(e=>"media"===e.type).model.blocks.find(e=>"mediaMetadata"===e.type).model:null,h=async(e,t,i,a,n,s,l,o,r,d,u,g,b,h)=>{let f=await y(e,g,b,t,s,l),{sessionLabels:C,playlistLabels:v,counterName:S,destination:w,producer:I}=c(r,d,s,t,h,g);return p(f,m(e,w,s?"SOUNDS":I,C,v),t,i,S,a,n,s,0,o,u,l)},f=async(e,t,i,a,n,s,l="Y",o)=>{let d="Y"===l?"portrait":"landscape",u=await S(t,i,a,n,s,d,o);o?.[i]&&Object.assign(e.playlistObject,r(o[i],d)),u.queuedPlaylist&&v(e.playlistObject,"queuedPlaylist",u.queuedPlaylist,u.queuedOptions),u.previousPlaylist&&v(e.playlistObject,"previousPlaylist",u.previousPlaylist,u.previousOptions)},C=async(e,t,i,a,n,s)=>{let l=[];for(let e=0;e<t.length;e++){let o=b(t[e]),r=await y(o,s,s,i),{sessionLabels:d,playlistLabels:u,counterName:p,destination:g,producer:h}=c(a,n[e],!1,i),f={playlist:r,statsObject:m(o,g,h,d,u),showLiveOrDuration:!0,counterName:p,autoplay:t.length>2};l.push(f)}return e.plugins?.toLoad.push({html:"name:onwardJourney.js",data:{name:"smp.plugin.continuousplay.playlistSetChanged",data:{items:l,stopAutoplayOnGuidance:!0}}}),l},v=(e,t,i,a)=>{Object.defineProperty(e,t,{value:i,enumerable:!1,configurable:!0}),a&&Object.defineProperty(e,"queuedPlaylist"===t?"queuedOptions":"previousOptions",{value:a,enumerable:!1,configurable:!0})},S=async(e,t,i,a,n,s,l)=>{let o=e.map(e=>b(e)),r=await Promise.all(o.map(e=>y(e,s,s,i)));if(l)for(let e=0;e<r.length;e++){let t=l[e];t&&(r[e].holdingImage={url:t,orientation:s})}let d=o.map((e,t)=>{let{sessionLabels:l,playlistLabels:o,destination:r,producer:d}=c(a,n[t],!1,i,s),u=o.av_content_genre;return m(e,r,d,l,{...o,content_topic:o.content_topic??"",av_content_genre:Array.isArray(u)?u.join(", "):u??""})});for(let e=0;e<r.length-1;e++)v(r[e],"queuedPlaylist",r[e+1],{statsObject:d[e+1],autoplay:!0});for(let e=1;e<r.length;e++)v(r[e],"previousPlaylist",r[e-1],{statsObject:d[e-1],autoplay:!0});return r[t]};e.s(["createSMPsettingsForLiveWorldNews",0,(e,t,i,a,n)=>{let s=[{live:!0,kind:"programme",serviceID:e}];t&&s.unshift({kind:"advert"});let{sessionLabels:l,playlistLabels:o,counterName:r,destination:d,producer:u}=c(a,n);return p({title:"",summary:"",items:s,holdingImageURL:"https://ichef.bbci.co.uk/images/ic/raw/p0g6qbw7.jpg",liveRewind:!0,simulcast:!0},{clipPID:"",playlistName:"",playerPosition:"",destination:d,producer:u,sessionLabels:l,playlistLabels:o},t,i,r,!1)},"createSMPsettingsFromBlock",0,h,"findBlockIndexByVersionId",0,(e,t)=>e.findIndex(e=>{let i=b(e),[a]=i?.versions||[];return a?.versionId===t}),"getAvAnalytics",0,c,"getCtaProps",0,e=>{let t=e.items[e.items.length-1];return{duration:t.duration?d(t.duration):"",warning:e.warning||""}},"getImageUrl",0,u,"getMediaMetaDataBlockModelFromVideoBlock",0,b,"isContentAvailableInTerritory",0,(e,t)=>{let[a]=b(t).versions,{availableTerritories:n}=a??{};if(!n)return!0;let s=e===i.COUNTRY_UK,l=n.uk,o=n.nonUk;return s?l:o},"loadOnwardJourneyPlugin",0,C,"loadSwipeablePlaylist",0,f,"secondsToMMSS",0,d])},46230,518628,753630,e=>{"use strict";var t=e.i(391398),i=e.i(191788),a=e.i(184919),n=e.i(753924),s=e.i(868783),l=e.i(519894),o=e.i(704570),r=e.i(608554),d=(0,e.i(344948).default)(function(e,t,i){(0,r.default)(e,t,i)}),u=e.i(399274),c=e.i(246024),p=e.i(317166),g=e.i(427885),y=e.i(879677),m=e.i(789799),b=e.i(508259),h=e.i(852827),f=e.i(184874);function C(e=[]){let t=e.find(e=>"media"===e.type);if(t){let e=(0,f.getNestedValue)(t,"rawImage","width"),i=(0,f.getNestedValue)(t,"rawImage","height");if(Number.isInteger(e)&&Number.isInteger(i))return e===i?"square":e<i?"portrait":"landscape"}return"landscape"}e.s(["getHoldingImageOrientation",0,C],518628);let v="There was an error",S="This content is not available in your location.";e.s(["errorSubTitle",0,S,"errorTitle",0,v,"playerContainerProps",0,{$type:"mobileFullWidth",$marginBottom:["s","m","m","m","m","m"]}],753630);var w=e.i(978113),I=e.i(318438),x=e.i(760814),P=e.i(339228);let E=x.default.div.withConfig({displayName:"SpaPlayerInner.styles__SpaPlayerInnerStyled",componentId:"sc-82491dc0-0"})(({$isAudio:e=!1,$isVerticalVideoPage:t=!1,$orientation:i})=>x.css`
    width: 100%;
    height: auto;
    visibility: hidden;
