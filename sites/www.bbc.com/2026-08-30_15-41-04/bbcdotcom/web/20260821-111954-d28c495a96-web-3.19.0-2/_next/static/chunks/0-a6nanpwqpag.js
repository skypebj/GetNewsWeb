...
`,d=p.default.div.withConfig({displayName:"Manchester.styles__CardStyled",componentId:"sc-5c1d085b-1"})`
  ...
  `}
`,c=p.default.div.withConfig({displayName:"Manchester.styles__TextWrapperStyled",componentId:"sc-5c1d085b-2"})`
  position: relative;
  gap: 8px;
  display: grid;
`;e.s(["default",0,({description:e,metadata:p,testId:o="",title:i,href:y,isLiveNow:g,hideMetadata:u,hideBottomBorder:m,linkType:h})=>{let{contentType:x="article"}=p;return(0,a.jsx)(t.default,{href:y,linkType:h,children:(0,a.jsx)(d,{"data-testid":`${o}${l}-${x}`,$hideMetadata:!u,$hideBottomBorder:m,children:(0,a.jsxs)(c,{"data-testid":"card-text-wrapper",children:[i&&(0,a.jsx)(s.default,{contentType:x,title:i,type:l,isLiveNow:g}),e&&(0,a.jsx)(n,{"data-testid":"card-description",children:e}),!u&&p&&(0,a.jsx)(r.default,{...p,cardType:l,layout:"bottom",href:y})]})})})}],154312)},461239,e=>{e.n(e.i(154312))}]);