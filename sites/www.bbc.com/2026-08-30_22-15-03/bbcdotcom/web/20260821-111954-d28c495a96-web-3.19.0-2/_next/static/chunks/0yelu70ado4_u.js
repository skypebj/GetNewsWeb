...
`,i=t.default.span.withConfig({displayName:"Image.styles__CreditStyled",componentId:"sc-8c99a12b-2"})`
  ...
  `};
`;e.s(["CreditStyled",0,i,"ImageCardStyled",0,a,"ImageStyled",0,o])},450228,e=>{"use strict";var t=e.i(391398),r=e.i(191788),n=e.i(184919),o=e.i(868783),a=e.i(270340),i=e.i(704570),s=e.i(876278),l=e.i(808824),u=e.i(120012),c=e.i(823575);let d=(0,o.withCMSFallback)((0,r.memo)(({imageUrlTemplate:e,cardType:o="",sizes:c,isFullHeight:d=!1,isDefaultAspectRatio:p="article"!==o,alt:g="",loading:h,fetchPriority:f,webpSupport:b=!0,isInverse:w=!1,testId:m})=>{let{type:v,os:x={},browser:y={}}=(0,i.usePageData)(),{getIsEager:$}=(0,a.useEagerImages)(),S=(0,l.getIsPlaceholderSupported)({os:x,browser:y}),[E,k]=(0,r.useState)(!1),[I,C]=(0,r.useState)(S),T=(0,r.useRef)(null),R=p??v===n.ContentType.IndexPage,_=c??(0,l.getSizesByCardType)(o,"96vw",g),A=b&&(0,l.supportsWebP)({os:x,browser:y}),B=(0,l.getSrcAndSrcSet)(e,R,A),L=B.mainImageSource,P=h??($(L)?"eager":"lazy");return(0,r.useEffect)(()=>{T?.current?.complete&&C(!1)}),(0,t.jsxs)(t.Fragment,{children:[I&&(0,t.jsx)(u.ImageStyled,{src:s.prefixedPlaceholderImage,isFullHeight:d,className:"hide-when-no-script","data-testid":m,"aria-label":"image unavailable",$isPlaceholder:!0}),(0,t.jsx)(u.ImageStyled,{$cardType:o,ref:T,sizes:E?"":_,srcSet:E?"":B.srcSet,src:E?s.INDEX_CARD_IMAGE_FALLBACK:L,isFullHeight:d,loading:P,fetchpriority:f,alt:g,onError:()=>k(!0),onLoad:()=>C(!1),$hasPlaceholder:!B.srcSet||E,$isInverse:w,"data-testid":m,$isPlaceholder:L===s.INDEX_CARD_IMAGE_FALLBACK})]})}),({imageUrlTemplate:e,cardType:r="",isFullHeight:o=!1,alt:a="",isInverse:l=!1,testId:d})=>{let{type:p}=(0,i.usePageData)(),g=function(e="",t=!0){if(e.includes("/ic/")){let r=e.includes("{recipe}")?(0,c.getAudioImageSrc)(e):e,n=`480x${t?"270":"n"}`;return r.replace("1920xn",n)}return e.includes("/news/")?e.replace("$recipe","480"):e.includes("/ace/")?e.replace("$recipe","480"):s.INDEX_CARD_IMAGE_FALLBACK}(e,"article"!==r||p===n.ContentType.IndexPage);return(0,t.jsx)(u.ImageStyled,{$cardType:r,src:g,isFullHeight:o,loading:"eager",alt:a,$isInverse:l,"data-testid":d})});e.s(["default",0,d],450228)},567290,e=>{"use strict";var t=e.i(760814),r=e.i(339228),n=e.i(570549);let o={left:"row",right:"row-reverse",top:"column",bottom:"column-reverse"},a=t.default.span.withConfig({displayName:"Button.styles__ButtonIcon",componentId:"sc-c0f7f974-0"})`
...
`,l=(0,t.default)(s).withConfig({displayName:"Button.styles__GeneralButton",componentId:"sc-c0f7f974-3"})`
  ${({theme:e,isInverse:r})=>{let n=r?"inverse":"normal";return t.css`
    ...
    `}}
`,u=(0,t.default)(s).withConfig({displayName:"Button.styles__GhostButton",componentId:"sc-c0f7f974-4"})`
  ${({theme:e,isInverse:r})=>{let n=r?"inverse":"normal";return t.css`
    ...
    `}};
`,c=(0,t.default)(s).withConfig({displayName:"Button.styles__UnboxedButton",componentId:"sc-c0f7f974-5"})`
  ${({theme:e,isInverse:r,withoutPaddingInline:n=!1,withoutPaddingBlock:o=!1})=>{let a=r?"inverse":"normal";return t.css`
    ...
    `}}
`,d=(0,t.default)(c).withConfig({displayName:"Button.styles__UnboxedShareButton",componentId:"sc-c0f7f974-6"})`
...
`,g=(0,t.default)(s).withConfig({displayName:"Button.styles__RoundButton",componentId:"sc-c0f7f974-8"})`
  ${({isInverse:e,withoutPaddingBlock:r,withoutPaddingInline:n,isSelected:o})=>t.css`
    ...
    `};
  `}
`;e.s(["ButtonBase",0,s,"ButtonIcon",0,a,"ButtonText",0,i,"GeneralButton",0,l,"GhostButton",0,u,"RoundButton",0,g,"SocialUnboxedShareButton",0,p,"UnboxedButton",0,c,"UnboxedShareButton",0,d])},84541,e=>{"use strict";var t=e.i(391398),r=e.i(191788),n=e.i(65739),o=e.i(450228),a=e.i(567290);let i={general:a.GeneralButton,ghost:a.GhostButton,unboxed:a.UnboxedButton,"unboxed-share":a.UnboxedShareButton,"social-follow-us":a.UnboxedShareButton,"social-unboxed-share":a.SocialUnboxedShareButton,round:a.RoundButton},s=(0,r.forwardRef)(({tabIndex:e,text:r,icon:s,img:l,alt:u="",type:c="general",size:d="large",onClick:p=()=>null,disabled:g=!1,iconPosition:h="left",iconProps:{ref:f=null,...b}={},testId:w,iconTestId:m,isInverse:v=!1,withoutPaddingInline:x=!1,withoutPaddingBlock:y=!1,isSubmit:$=!1,isHeaderButton:S=!1,onMouseEnter:E=()=>null,onMouseLeave:k=()=>null,ariaLabel:I,isSelected:C=!1,isInPopover:T=!1,...R},_)=>{let A=i[c];return r||s?(0,t.jsxs)(A,{withoutPaddingInline:x,withoutPaddingBlock:y,isInverse:v,buttonSize:d,disabled:g,type:$?"submit":"button",variant:c,onClick:p,"data-testid":w,iconPosition:h,"aria-label":I||r,isHeaderButton:S,onMouseEnter:E,onMouseLeave:k,ref:_,isInPopover:T,isSelected:C,tabIndex:e,...R,children:[(s||l)&&(0,t.jsxs)(a.ButtonIcon,{"data-testid":"button-icon-wrapper",$type:c,$isSelected:C,$isInPopover:T,$isInverse:v,$size:d,children:[l&&(0,t.jsx)(o.default,{imageUrlTemplate:l,alt:u}),s&&(0,t.jsx)(n.default,{...b,name:s,testId:m,ref:f,"aria-hidden":!0})]}),r&&(0,t.jsx)(a.ButtonText,{"data-testid":"button-text","aria-hidden":!!I,children:r})]}):null});e.s(["default",0,s],84541)},760121,(e,t,r)=>{"use strict";var n=e.r(191788),o="function"==typeof Object.is?Object.is:function(e,t){return e===t&&(0!==e||1/e==1/t)||e!=e&&t!=t},a=n.useState,i=n.useEffect,s=n.useLayoutEffect,l=n.useDebugValue;function u(e){var t=e.getSnapshot;e=e.value;try{var r=t();return!o(e,r)}catch(e){return!0}}var c="u"<typeof window||void 0===window.document||void 0===window.document.createElement?function(e,t){return t()}:function(e,t){var r=t(),n=a({inst:{value:r,getSnapshot:t}}),o=n[0].inst,c=n[1];return s(function(){o.value=r,o.getSnapshot=t,u(o)&&c({inst:o})},[e,r,t]),i(function(){return u(o)&&c({inst:o}),e(function(){u(o)&&c({inst:o})})},[e]),l(r),r};r.useSyncExternalStore=void 0!==n.useSyncExternalStore?n.useSyncExternalStore:c},890979,(e,t,r)=>{"use strict";t.exports=e.r(760121)},317166,116240,959560,e=>{"use strict";var t=e.i(191788),r=e.i(480495),n=e.i(890979);let o=()=>{},a=o(),i=Object,s=e=>e===a,l=e=>"function"==typeof e,u=(e,t)=>({...e,...t}),c=new WeakMap,d=0,p=e=>{let t,r,n=typeof e,o=e&&e.constructor,a=o==Date;if(i(e)!==e||a||o==RegExp)t=a?e.toJSON():"symbol"==n?e.toString():"string"==n?JSON.stringify(e):""+e;else{if(t=c.get(e))return t;if(t=++d+"~",c.set(e,t),o==Array){for(r=0,t="@";r<e.length;r++)t+=p(e[r])+",";c.set(e,t)}if(o==i){t="#";let n=i.keys(e).sort();for(;!s(r=n.pop());)s(e[r])||(t+=r+":"+p(e[r])+",");c.set(e,t)}}return t},g=new WeakMap,h={},f={},b="undefined",w=typeof window!=b,m=typeof document!=b,v=(e,t)=>{let r=g.get(e);return[()=>!s(t)&&e.get(t)||h,n=>{if(!s(t)){let o=e.get(t);t in f||(f[t]=o),r[5](t,u(o,n),o||h)}},r[6],()=>!s(t)&&t in f?f[t]:!s(t)&&e.get(t)||h]},x=!0,[y,$]=w&&window.addEventListener?[window.addEventListener.bind(window),window.removeEventListener.bind(window)]:[o,o],S={initFocus:e=>(m&&document.addEventListener("visibilitychange",e),y("focus",e),()=>{m&&document.removeEventListener("visibilitychange",e),$("focus",e)}),initReconnect:e=>{let t=()=>{x=!0,e()},r=()=>{x=!1};return y("online",t),y("offline",r),()=>{$("online",t),$("offline",r)}}},E=!t.default.useId,k=!w||"Deno"in window,I=e=>w&&typeof window.requestAnimationFrame!=b?window.requestAnimationFrame(e):setTimeout(e,1),C=k?t.useEffect:t.useLayoutEffect,T="u">typeof navigator&&navigator.connection,R=!k&&T&&(["slow-2g","2g"].includes(T.effectiveType)||T.saveData),_=e=>{if(l(e))try{e=e()}catch(t){e=""}let t=e;return[e="string"==typeof e?e:(Array.isArray(e)?e.length:e)?p(e):"",t]},A=0,B=()=>++A;var L={__proto__:null,ERROR_REVALIDATE_EVENT:3,FOCUS_EVENT:0,MUTATE_EVENT:2,RECONNECT_EVENT:1};async function P(...e){let[t,r,n,o]=e,i=u({populateCache:!0,throwOnError:!0},"boolean"==typeof o?{revalidate:o}:o||{}),c=i.populateCache,d=i.rollbackOnError,p=i.optimisticData,h=!1!==i.revalidate,f=i.throwOnError;if(l(r)){let e=[];for(let n of t.keys())!/^\$(inf|sub)\$/.test(n)&&r(t.get(n)._k)&&e.push(n);return Promise.all(e.map(b))}return b(r);async function b(r){let o,[i]=_(r);if(!i)return;let[u,b]=v(t,i),[w,m,x,y]=g.get(t),$=w[i],S=()=>h&&(delete x[i],delete y[i],$&&$[0])?$[0](2).then(()=>u().data):u().data;if(e.length<3)return S();let E=n,k=B();m[i]=[k,0];let I=!s(p),C=u(),T=C.data,R=C._c,A=s(R)?T:R;if(I&&b({data:p=l(p)?p(A,T):p,_c:A}),l(E))try{E=E(A)}catch(e){o=e}if(E&&l(E.then)){let e;if(E=await E.catch(e=>{o=e}),k!==m[i][0]){if(o)throw o;return E}o&&I&&(e=o,"function"==typeof d?d(e):!1!==d)&&(c=!0,b({data:E=A,_c:a}))}c&&!o&&(l(c)&&(E=c(E,A)),b({data:E,error:a,_c:a})),m[i][1]=B();let L=await S();if(b({_c:a}),o){if(f)throw o;return}return c?L:E}}let O=(e,t)=>{for(let r in e)e[r][0]&&e[r][0](t)},N=(e,t)=>{if(!g.has(e)){let r=u(S,t),n={},i=P.bind(a,e),s=o,l={},c=(e,t)=>{let r=l[e]||[];return l[e]=r,r.push(t),()=>r.splice(r.indexOf(t),1)},d=(t,r,n)=>{e.set(t,r);let o=l[t];if(o)for(let e of o)e(r,n)},p=()=>{if(!g.has(e)&&(g.set(e,[n,{},{},{},i,d,c]),!k)){let t=r.initFocus(setTimeout.bind(a,O.bind(a,n,0))),o=r.initReconnect(setTimeout.bind(a,O.bind(a,n,1)));s=()=>{t&&t(),o&&o(),g.delete(e)}}};return p(),[e,i,p,s]}return[e,g.get(e)[4]]},[D,U]=N(new Map),F=u({onLoadingSlow:o,onSuccess:o,onError:o,onErrorRetry:(e,t,r,n,o)=>{let a=r.errorRetryCount,i=o.retryCount,l=~~((Math.random()+.5)*(1<<(i<8?i:8)))*r.errorRetryInterval;(s(a)||!(i>a))&&setTimeout(n,l,o)},onDiscarded:o,revalidateOnFocus:!0,revalidateOnReconnect:!0,revalidateIfStale:!0,shouldRetryOnError:!0,errorRetryInterval:R?1e4:5e3,focusThrottleInterval:5e3,dedupingInterval:2e3,loadingTimeout:R?5e3:3e3,compare:(e,t)=>p(e)==p(t),isPaused:()=>!1,cache:D,mutate:U,fallback:{}},{isOnline:()=>x,isVisible:()=>{let e=m&&document.visibilityState;return s(e)||"hidden"!==e}}),V=(e,t)=>{let r=u(e,t);if(t){let{use:n,fallback:o}=e,{use:a,fallback:i}=t;n&&a&&(r.use=n.concat(a)),o&&i&&(r.fallback=u(o,i))}return r},j=(0,t.createContext)({}),M=e=>{let{value:r}=e,n=(0,t.useContext)(j),o=l(r),i=(0,t.useMemo)(()=>o?r(n):r,[o,n,r]),s=(0,t.useMemo)(()=>o?i:V(n,i),[o,n,i]),c=i&&i.provider,d=(0,t.useRef)(a);c&&!d.current&&(d.current=N(c(s.cache||D),i));let p=d.current;return p&&(s.cache=p[0],s.mutate=p[1]),C(()=>{if(p)return p[2]&&p[2](),p[3]},[]),(0,t.createElement)(j.Provider,u(e,{value:s}))},G=w&&window.__SWR_DEVTOOLS_USE__,W=G?window.__SWR_DEVTOOLS_USE__:[],H=e=>l(e[1])?[e[0],e[1],e[2]||{}]:[e[0],null,(null===e[1]?e[2]:e[1])||{}],z=()=>u(F,(0,t.useContext)(j)),K=W.concat(e=>(t,r,n)=>{let o=r&&((...e)=>{let[n]=_(t),[,,,o]=g.get(D),a=o[n];return s(a)?r(...e):(delete o[n],a)});return e(t,o,n)}),J=e=>function(...t){let r=z(),[n,o,a]=H(t),i=V(r,a),s=e,{use:l}=i,u=(l||[]).concat(K);for(let e=u.length;e--;)s=u[e](s);return s(n,o||i.fetcher||null,i)},q=(e,t,r)=>{let n=t[e]||(t[e]=[]);return n.push(r),()=>{let e=n.indexOf(r);e>=0&&(n[e]=n[n.length-1],n.pop())}};G&&(window.__SWR_DEVTOOLS_REACT__=t.default),e.s(["IS_REACT_LEGACY",0,E,"IS_SERVER",0,k,"OBJECT",0,i,"SWRConfig",0,M,"SWRGlobalState",0,g,"UNDEFINED",0,a,"createCacheHelper",0,v,"defaultConfig",0,F,"getTimestamp",0,B,"internalMutate",0,P,"isFunction",0,l,"isUndefined",0,s,"mergeObjects",0,u,"rAF",0,I,"revalidateEvents",0,L,"serialize",0,_,"subscribeCallback",0,q,"useIsomorphicLayoutEffect",0,C,"useSWRConfig",0,z,"withArgs",0,J,"withMiddleware",0,(e,t)=>(...r)=>{let[n,o,a]=H(r),i=(a.use||[]).concat(t);return e(n,o,{...a,use:i})}],116240);let X=t.default.use||(e=>{if("pending"===e.status)throw e;if("fulfilled"===e.status)return e.value;if("rejected"===e.status)throw e.reason;throw e.status="pending",e.then(t=>{e.status="fulfilled",e.value=t},t=>{e.status="rejected",e.reason=t}),e}),Y={dedupe:!0},Q=i.defineProperty(M,"defaultValue",{value:F}),Z=J((e,r,o)=>{let{cache:i,compare:c,suspense:d,fallbackData:p,revalidateOnMount:h,revalidateIfStale:f,refreshInterval:b,refreshWhenHidden:w,refreshWhenOffline:m,keepPreviousData:x}=o,[y,$,S,T]=g.get(i),[R,A]=_(e),O=(0,t.useRef)(!1),N=(0,t.useRef)(!1),D=(0,t.useRef)(R),U=(0,t.useRef)(r),F=(0,t.useRef)(o),V=()=>F.current.isVisible()&&F.current.isOnline(),[j,M,G,W]=v(i,R),H=(0,t.useRef)({}).current,z=s(p)?o.fallback[R]:p,K=(e,t)=>{for(let r in H)if("data"===r){if(!c(e[r],t[r])&&(!s(e[r])||!c(ea,t[r])))return!1}else if(t[r]!==e[r])return!1;return!0},J=(0,t.useMemo)(()=>{let e=!!R&&!!r&&(s(h)?!F.current.isPaused()&&!d&&(!!s(f)||f):h),t=t=>{let r=u(t);return(delete r._k,e)?{isValidating:!0,isLoading:!0,...r}:r},n=j(),o=W(),a=t(n),i=n===o?a:t(o),l=a;return[()=>{let e=t(j());return K(e,l)?(l.data=e.data,l.isLoading=e.isLoading,l.isValidating=e.isValidating,l.error=e.error,l):(l=e,e)},()=>i]},[i,R]),Q=(0,n.useSyncExternalStore)((0,t.useCallback)(e=>G(R,(t,r)=>{K(r,t)||e()}),[i,R]),J[0],J[1]),Z=!O.current,ee=y[R]&&y[R].length>0,et=Q.data,er=s(et)?z:et,en=Q.error,eo=(0,t.useRef)(er),ea=x?s(et)?eo.current:et:er,ei=(!ee||!!s(en))&&(Z&&!s(h)?h:!F.current.isPaused()&&(d?!s(er)&&f:s(er)||f)),es=!!(R&&r&&Z&&ei),el=s(Q.isValidating)?es:Q.isValidating,eu=s(Q.isLoading)?es:Q.isLoading,ec=(0,t.useCallback)(async e=>{let t,r,n=U.current;if(!R||!n||N.current||F.current.isPaused())return!1;let i=!0,u=e||{},d=!S[R]||!u.dedupe,p=()=>E?!N.current&&R===D.current&&O.current:R===D.current,g={isValidating:!1,isLoading:!1},h=()=>{M(g)},f=()=>{let e=S[R];e&&e[1]===r&&delete S[R]},b={isValidating:!0};s(j().data)&&(b.isLoading=!0);try{if(d&&(M(b),o.loadingTimeout&&s(j().data)&&setTimeout(()=>{i&&p()&&F.current.onLoadingSlow(R,o)},o.loadingTimeout),S[R]=[n(A),B()]),[t,r]=S[R],t=await t,d&&setTimeout(f,o.dedupingInterval),!S[R]||S[R][1]!==r)return d&&p()&&F.current.onDiscarded(R),!1;g.error=a;let e=$[R];if(!s(e)&&(r<=e[0]||r<=e[1]||0===e[1]))return h(),d&&p()&&F.current.onDiscarded(R),!1;let l=j().data;g.data=c(l,t)?l:t,d&&p()&&F.current.onSuccess(t,R,o)}catch(r){f();let e=F.current,{shouldRetryOnError:t}=e;!e.isPaused()&&(g.error=r,d&&p()&&(e.onError(r,R,e),(!0===t||l(t)&&t(r))&&V()&&e.onErrorRetry(r,R,e,e=>{let t=y[R];t&&t[0]&&t[0](L.ERROR_REVALIDATE_EVENT,e)},{retryCount:(u.retryCount||0)+1,dedupe:!0})))}return i=!1,h(),!0},[R,i]),ed=(0,t.useCallback)((...e)=>P(i,D.current,...e),[]);if(C(()=>{U.current=r,F.current=o,s(et)||(eo.current=et)}),C(()=>{if(!R)return;let e=ec.bind(a,Y),t=0,r=q(R,y,(r,n={})=>{if(r==L.FOCUS_EVENT){let r=Date.now();F.current.revalidateOnFocus&&r>t&&V()&&(t=r+F.current.focusThrottleInterval,e())}else if(r==L.RECONNECT_EVENT)F.current.revalidateOnReconnect&&V()&&e();else if(r==L.MUTATE_EVENT)return ec();else if(r==L.ERROR_REVALIDATE_EVENT)return ec(n)});return N.current=!1,D.current=R,O.current=!0,M({_k:A}),ei&&(s(er)||k?e():I(e)),()=>{N.current=!0,r()}},[R]),C(()=>{let e;function t(){let t=l(b)?b(j().data):b;t&&-1!==e&&(e=setTimeout(r,t))}function r(){!j().error&&(w||F.current.isVisible())&&(m||F.current.isOnline())?ec(Y).then(t):t()}return t(),()=>{e&&(clearTimeout(e),e=-1)}},[b,w,m,R]),(0,t.useDebugValue)(ea),d&&s(er)&&R){if(!E&&k)throw Error("Fallback data is required when using suspense in SSR.");U.current=r,F.current=o,N.current=!1;let e=T[R];if(s(e)||X(ed(e)),s(en)){let e=ec(Y);s(ea)||(e.status="fulfilled",e.value=!0),X(e)}else throw en}return{mutate:ed,get data(){return H.data=!0,ea},get error(){return H.error=!0,en},get isValidating(){return H.isValidating=!0,el},get isLoading(){return H.isLoading=!0,eu}}});e.s(["SWRConfig",0,Q,"default",0,Z],959560);var ee=e.i(508259),et=e.i(830945);let er=(0,e.i(610503).default)(async e=>{let t=await fetch(e,{credentials:"include",headers:{"Content-Type":"application/json"}});if(!t.ok)throw Error(`fetch failed with status code ${t.status}`);return t},1e3,{leading:!0,trailing:!1});e.s(["useUser",0,function(){let{data:e,mutate:n}=Z("authInfo",null,{revalidateOnReconnect:!1,revalidateOnFocus:!1,revalidateIfStale:!0}),o=async()=>{let t=(0,r.getCookie)(et.USER_ID);if(!e||!t)return!1;if(e.isMissingAccessToken)"GREEN"===e.idAvailability&&"off"===e.accountMaintenanceMode&&(await er(e.accessTokenRefreshUrl),await n({...e,isMissingAccessToken:!1}));else{let{"tkn-exp":r}=JSON.parse(window.atob(t)),n=new Date(r-6e5);if(Date.now()<n.getTime())return!0;ee.logger.warn("Access token expired, refreshing"),"GREEN"===e.idAvailability&&"off"===e.accountMaintenanceMode&&await er(e.accessTokenRefreshUrl)}return!0};return(0,t.useEffect)(()=>{let t=(0,r.hasCookie)(et.USER_ID);e&&n({...e,isSignedIn:t})},[e,n]),{...e,ensureTokens:o}}],317166)},898229,732299,258069,e=>{"use strict";e.i(350461);var t=e.i(227162),r=e.i(395497),n=e.i(508259);class o extends Error{statusCode;constructor(e,t){super(e),this.statusCode=t}}e.s(["HTTPError",0,o],732299);let a=/^https?:\/\//i;async function i(e,i){let{isLegacyApiEnabled:s,params:l,paramsHaveIdenticalKeys:u,cache:c="default",correlationId:d,headers:p,revalidationTime:g,...h}=i,f=s&&t.appConfig.getValue(r.ConfigSettings.ApiUrlLegacy)||t.appConfig.getValue(r.ConfigSettings.ApiUrl),b=a.test(e),w=new URL(e,b?void 0:f),m=new Headers(p),v=parseInt(t.appConfig.getValue(r.ConfigSettings.ApiRevalidationTime)||`${g}`||"20"),x=u?[...new URLSearchParams(w.search),...new URLSearchParams(l)]:{...Object.fromEntries(new URLSearchParams(w.search)),...Object.fromEntries(new URLSearchParams(l))};w.search=new URLSearchParams(x).toString();let y={cache:c,next:{revalidate:v},headers:m,...h};n.logger.info(`HTTP request log: ${JSON.stringify({url:w,init:y})}`);let $=await fetch(w,y),S=await $.json();if($.status>=400)throw new o($.statusText,$.status);return{data:S,httpStatus:$.status,headers:$.headers}}e.s(["buildFetchInit",0,function(e,t){let r=new URLSearchParams(t),n=new URLSearchParams(e.params);return{...e,params:new URLSearchParams({...Object.fromEntries(n),...Object.fromEntries(r)})}},"default",0,i],258069),e.s(["fetchClient",0,i],898229)}]);