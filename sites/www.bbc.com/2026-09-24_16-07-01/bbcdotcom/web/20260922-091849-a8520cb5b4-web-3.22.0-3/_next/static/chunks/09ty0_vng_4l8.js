(globalThis.TURBOPACK||(globalThis.TURBOPACK=[])).push(["object"==typeof document?document.currentScript:void 0,551068,e=>{"use strict";var t=e.i(760814),n=e.i(339228),a=e.i(570549),i=e.i(222009),o=e.i(680516);let s=t.default.section.withConfig({displayName:"Navigation.styles__NavigationSectionStyled",componentId:"sc-f1c1fa10-0"})`
...
`,tp=(0,eg.createGlobalStyle)(({$isHeaderDefaultSize:e,$isBurgerMenuOpened:t})=>{let n=e?tl.HEADER_DEFAULT_HEIGHT+42:tl.HEADER_COLLAPSED_HEIGHT,a=e?tl.HEADER_DEFAULT_HEIGHT:tl.HEADER_COLLAPSED_HEIGHT,i=tl.HEADER_HEIGHT_MOBILE;return eg.css`
      .tp-backdrop {
        background-color: rgb(255 255 255 / 70%) !important;
        backdrop-filter: blur(4px);
        top: ${n}px !important;
        ${(0,tc.applyZIndex)("level2",!1,!0)};
      ...
      .tp-modal {
        ...
        ${(0,tc.applyZIndex)(t?"level2":"level3",!0,!0)};
...
`,tg=()=>{let[e]=(0,ti.useCurrentSlug)();return"subscribe"===e},tf=({isHeaderDefaultSize:e,isBurgerMenuOpened:t})=>{let n,i=tg(),{isSubscriptionAllowed:s}=(0,a.useSubscriptionContext)(),[r,l]=(0,o.useState)(!1),[c,d]=(0,o.useState)(!1),p=(0,to.useLogMparticleEvent)();return(0,e9.useBackdropObserver)(e=>{e&&p("paywall.subscription.view")},"piano"),(0,o.useEffect)(()=>{window.tp.push(["init",()=>l(!0)]),window.tp.push(["addHandler","showOffer",()=>d(!0)])},[]),(e=>{let{data:t}=(0,ta.default)("authInfo"),{statusUrl:n}=t||{},[a]=(0,ti.useCurrentSlug)();(0,o.useEffect)(()=>{if("managesubscription"===a&&e){let e=(0,u.getCookie)(tr.SUBSCRIPTION_SETTINGS_COOKIE),{authLevel2Expiry:t}=e?tn(String(e)):{},a=Math.round(new Date().getTime()/1e3);!t||t<a?window.location.href=`${n}${tr.SUBSCRIPTION_SETTINGS_MANAGEMENT}?web=true&ptrt=${window.location.href}`:window.tp.myaccount.show({displayMode:"inline",containerSelector:"#bbc-main",activateTemplateInteraction:!0})}},[n,a,e])})(r),(e=>{let[t]=(0,ti.useCurrentSlug)();(0,o.useEffect)(()=>{let t=new URLSearchParams(window.location.search).get("accountMarketingPreferences");if(t&&e){var n;n=[{field_name:tr.CUSTOM_FORM_FIELD_NAME,value:"on"===t?"true":"false"}],window.tp.api.callApi("/anon/user/get",{},async e=>{let t=er.appConfig.getValue(el.ConfigSettings.PianoApi),a=window.tp?.aid,i=window.tp?.pianoId?.getToken(),o=`${t}/identity/userinfo?lang=en_US&aid=${a}&access_token=${i}`,s=e?.user?.uid;a&&i&&s?await fetch(o,{method:"PUT",headers:{"Content-Type":"application/json; charset=UTF-8"},body:JSON.stringify({uid:s,form_name:tr.CUSTOM_FORM,custom_field_values:n})}).then(e=>{e.ok?ts.logger.info("Custom fields updated successfully"):ts.logger.error("Failed to update custom fields")}).catch(e=>{ts.logger.error("Error updating custom fields:",e)}):ts.logger.error(`Piano API credentials are missing: [pianoAid: ${a}, pianoToken: ${i}, pianoUid: ${s}]`)})}},[e,t])})(r),(()=>{let[e]=(0,ti.useCurrentSlug)();(0,o.useEffect)(()=>{"subscribe"===e&&window.tp.push(["addHandler","checkoutCustomEvent",e=>{"checkout-attempt"===e.eventName&&document?.querySelector(".tp-iframe-wrapper.tp-active")?.scrollIntoView({behavior:"smooth"})}])},[e])})(),n=tg(),(0,o.useEffect)(()=>{let e=new MutationObserver(e=>{e.forEach(e=>{let{type:t}=e,n=e.target;"attributes"===t&&n.matches("div.tp-backdrop")&&(n.classList.contains("tp-active")&&document.body.setAttribute("style","overflow: hidden"),n.classList.contains("tp-active")||document.body.removeAttribute("style"))})});return n||e.observe(document.body,{attributes:!0,subtree:!0,attributeFilter:["class"]}),()=>{e.disconnect(),document.body.removeAttribute("style")}},[n]),(e=>{let[t,n]=(0,o.useState)({}),[a,i]=(0,o.useState)(!1);(0,o.useEffect)(()=>{let e,t,a;e=window?.embeddedMedia?.api,t=0,a=setInterval(()=>{if(!e||!e.players)return;t+=1;let i=0===Object.keys(e?.players()??{}).length;if(i&&40===t){ts.logger.warn("embeddedMedia.api.players() returned no players after 40 attempts"),clearInterval(a);return}i||(n(e.players()),clearInterval(a))},100)},[]),(0,o.useEffect)(()=>{if(Object.keys(t).length>0)for(let[,e]of Object.entries(t))e.bind("playbackInterrupted",()=>i(!0));if(!a&&e)for(let[,e]of Object.entries(t))e.stop();if(a&&e)for(let[,e]of Object.entries(t))setTimeout(()=>{e.loadPlaylist({}),e.stop()},1500)},[t,e,a])})(c),(0,ec.jsxs)(ec.Fragment,{children:[(0,ec.jsx)(td,{$isSubscriptionAllowed:s}),(0,ec.jsx)(i?tu:tp,{$isHeaderDefaultSize:e,$isBurgerMenuOpened:t})]})};var th=e.i(276045);let tm=Object.keys(e.i(195214).breakpoints).reverse(),ty=eg.default.div.withConfig({displayName:"WatchLive.styles__WatchLiveStyled",componentId:"sc-6555d0cd-0"})`
  ${({theme:e,$visibleForBreakpoints:t})=>eg.css`
    ...
    ${tm.map(e=>{let n=t.includes(e),a=eg.css`
    ...
    ${(0,ef.applyStylesForBreakpoints)(eg.css`
      ...
      `,"group2")};
  `};
`,tv=eg.default.span.withConfig({displayName:"WatchLive.styles__WatchLiveContentStyled",componentId:"sc-6555d0cd-1"})`
  display: inline-flex;
  align-items: center;
  column-gap: 4px;
`,tb=eg.default.span.withConfig({displayName:"WatchLive.styles__WatchLiveIconStyled",componentId:"sc-6555d0cd-2"})`
  display: inline-flex;
  align-items: center;
  justify-content: center;
  width: 20px;
...
`,tx=({withAnimation:e=!1,visibleForBreakpoints:t=[]})=>{let{worldNewsTvPath:n}=(0,th.useWorldNewsData)();return n?(0,ec.jsx)(ty,{$visibleForBreakpoints:t,children:(0,ec.jsx)(ed.default,{analyticsProps:{item_name:"WatchLive - Watch Live",item_type:"watch_live_button"},href:n,children:(0,ec.jsxs)(tv,{children:[(0,ec.jsx)(tb,{children:(0,ec.jsx)(ew.default,{name:"content-types:live",withAnimation:e})}),(0,ec.jsx)("span",{children:"Watch Live"})]})})}):null};e.s(["default",0,tx],871071);let tw=eg.default.header.withConfig({displayName:"Header.styles__HeaderStyled",componentId:"sc-36071384-0"})`
  ${({theme:e,$isHeaderDefaultSize:t,$isPianoModalVisible:n=!1})=>eg.css`
    position: ${n?"fixed":"sticky"};
    top: 0;
    left: 0;
    right: 0;
    height: ${t?tl.HEADER_DEFAULT_HEIGHT:tl.HEADER_COLLAPSED_HEIGHT}px;
    background-color: ${e.nav.level1.bgDefault.value};
    border-bottom: 1px solid ${e.nav.lines.value};
    ${(0,tc.applyZIndex)("level4")};
    transition: height 0.5s ease;

    ${(0,ef.applyStylesForBreakpoints)(eg.css`
        height: ${tl.HEADER_HEIGHT_MOBILE}px;
      `,"group2")};
  `};
`,tS=eg.default.div.withConfig({displayName:"Header.styles__HeaderContentStyled",componentId:"sc-36071384-1"})`
  ${({$isHeaderDefaultSize:e})=>eg.css`
    ...
    ${(0,ef.applyStylesForBreakpoints)(eg.css`
      ...
      `,"group2")};
  `}
`,t_=eg.default.div.withConfig({displayName:"Header.styles__HeaderLogoStyled",componentId:"sc-36071384-2"})`
  ${({$isHeaderDefaultSize:e})=>eg.css`
    display: flex;
    align-items: center;
    justify-content: center;
  ...
  `}
`,t$=eg.default.button.withConfig({displayName:"Header.styles__HeaderMenuButtonStyled",componentId:"sc-36071384-3"})`
  ${({theme:e,$isBurgerMenuOpened:t})=>eg.css`
    ...
    `}
  `};
`,tk=eg.default.div.attrs({className:"hide-when-no-script"}).withConfig({displayName:"Header.styles__HeaderMenuContainerStyled",componentId:"sc-36071384-4"})`
  ...
  `};
`,tN=eg.default.div.withConfig({displayName:"Header.styles__HeaderLogoContainerStyled",componentId:"sc-36071384-5"})`
  flex: 1;
  display: flex;
  justify-content: center;
  height: 32px;
`,tI=eg.default.div.withConfig({displayName:"Header.styles__HeaderButtonsContainerStyled",componentId:"sc-36071384-6"})`
  flex: 1;
  display: flex;
  align-items: center;
  justify-content: end;
  gap: 20px;
  height: 40px;
`,tC=({isBurgerMenuOpened:e,onClick:t,buttonRef:n})=>(0,ec.jsx)(t$,{ref:n,onClick:t,role:"button","aria-expanded":e,"aria-label":e?"Close menu":"Open menu",$isBurgerMenuOpened:e,children:(0,ec.jsx)(ew.default,{name:e?"actions:close":"actions:toggle",width:20,height:20,"aria-hidden":!0})}),tT=(0,o.forwardRef)(({isBurgerMenuOpened:e,onToggleMenuClick:t,onHeaderLogoClick:n,mainPageUrl:a,actions:i,toggleMenuButtonRef:s,isHeaderDefaultSize:r,id:l},c)=>{let[d,p]=(0,o.useState)(!1),u=(0,eu.getNavigationAnalytics)("header","Header BBC icon","",a.toString(),"header");return(0,e9.useBackdropObserver)(p,"piano"),(0,ec.jsx)(tw,{id:l,ref:c,$isHeaderDefaultSize:r,$isPianoModalVisible:d,children:(0,ec.jsxs)(tS,{$isHeaderDefaultSize:r,children:[(0,ec.jsxs)(tk,{$isBurgerMenuOpened:e,children:[(0,ec.jsx)(tC,{buttonRef:s,onClick:t,isBurgerMenuOpened:e}),(0,ec.jsx)(tx,{withAnimation:!0,visibleForBreakpoints:["group6","group5","group4","group3"]})]}),(0,ec.jsx)(tN,{children:(0,ec.jsx)(t_,{onClick:n,$isHeaderDefaultSize:r,children:(0,ec.jsx)(ed.default,{href:a,analytics:u,children:(0,ec.jsx)(ew.default,{name:"logo:bbc"})})})}),(0,ec.jsxs)(tI,{children:[(0,ec.jsx)(tf,{isHeaderDefaultSize:r,isBurgerMenuOpened:e}),(0,ec.jsx)(e7.AccountButtons,{actions:i,onToggleMenuClick:t,isBurgerMenuOpened:e})]})]})})});e.s(["default",0,tT],219717);var tj=e.i(84541);let tE=eg.default.div.withConfig({displayName:"DismissableError.styles__DismissibleErrorContainerStyled",componentId:"sc-c275520f-0"})`
  ${({theme:e})=>eg.css`
    position: absolute;
    left: 0;
    right: 0;
    ...
    z-index: 500;
  `};
`,tA=eg.default.div.withConfig({displayName:"DismissableError.styles__DismissibleErrorInnerContainerStyled",componentId:"sc-c275520f-1"})`
  max-width: 932px;
  margin: auto;
  width: 100%;
  display: flex;
