...
var Bootstrapper = window["CalTimes"]; var ensightenOptions = CalTimes.ensightenOptions;
CalTimes.registerDataDefinition(function (){CalTimes.data.define( {extract: function() {
	    return window?.dataLayer?.currentGame?.id;
},transform: function(val) {
	return val ? val : "";
},load: 'instance',trigger: Bootstrapper.data.immediateTrigger,dataDefName: 'game_id',collection: 'Pulse Page Load',source: 'Manage',priv: 'false'}, {id: '74291'} );},74291);

},-1, -1, -1);
CalTimes.bindImmediate(function(){
var Bootstrapper = window["CalTimes"]; var ensightenOptions = CalTimes.ensightenOptions;
CalTimes.registerDataDefinition(function (){CalTimes.data.define( {extract: function() {
	    return window?.dataLayer?.currentGame?.publishDate;
},transform: function(val) {
	return val ? val : "";
},load: 'instance',trigger: Bootstrapper.data.immediateTrigger,dataDefName: 'game_publishDate',collection: 'Pulse Page Load',source: 'Manage',priv: 'false'}, {id: '74292'} );},74292);

},-1, -1, -1);
CalTimes.bindImmediate(function(){
var Bootstrapper = window["CalTimes"]; var ensightenOptions = CalTimes.ensightenOptions;
CalTimes.registerDataDefinition(function (){CalTimes.data.define( {extract: function() {
	    return window?.dataLayer?.currentGame?.title;
},transform: function(val) {
	return val ? val : "";
},load: 'instance',trigger: Bootstrapper.data.immediateTrigger,dataDefName: 'game_title',collection: 'Pulse Page Load',source: 'Manage',priv: 'false'}, {id: '74293'} );},74293);
